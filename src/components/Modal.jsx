...
export default function Modal({ children, setShow, label }) {
  return (
    <div
    ...
    >
      <div
        ...
        className='bg-[#2E2F38] sm:w-[30rem] sm:h-auto w-screen h-screen rounded text-white sm:px-8 px-4 pt-6 pb-12 flex flex-col gap-2'
      >
